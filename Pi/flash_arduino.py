...
MCU = "atmega328p"
PROGRAMMER = "arduino"
SKETCH_DIR = os.path.expanduser("~/Cluster/Arduino/Core_Backend")
FIRMWARE_DEST = os.path.expanduser("~/Cluster/Firmware/firmware.hex")
...
def reset_arduino_and_flash():
    ...
    try:
        ...
        print("⏱️ Flashing timed out. Arduino may not be in bootloader.")
        sys.exit(1)
