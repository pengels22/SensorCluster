...
BLUETOOTH_ICON = None
try:
    WIFI_ICON = Image.open("/home/pi/Pi/icons/wifi.png").convert("1").resize((12,12), Image.LANCZOS)
    WIFI_ICON = ImageOps.invert(WIFI_ICON.convert("L"))
    BLUETOOTH_ICON = Image.open("/home/pi/Pi/icons/bluetooth.png").convert("1").resize((16,16), Image.LANCZOS)
